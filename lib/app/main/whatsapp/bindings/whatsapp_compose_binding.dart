...
import '../controllers/whatsapp_compose_controller.dart';

class WhatsAppComposeBinding extends Bindings {
  @override
  void dependencies() {
    ...
    Get.lazyPut<WhatsAppComposeController>(() => WhatsAppComposeController());
  }
}
